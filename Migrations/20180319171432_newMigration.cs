        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasManageAccess = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateDeath = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                    GoogleImageCache = table.Column<string>(nullable: true),
                    Name = table.Column<string>(nullable: true),
                    NameCs = table.Column<string>(nullable: true),
                    NameEn = table.Column<string>(nullable: true),
                    OriginalImage = table.Column<string>(nullable: true),
                    Sex = table.Column<int>(nullable: true),
                    Uri = table.Column<string>(nullable: false),
                    WikipediaPage = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Authors", x => x.AuthorId);
                    table.UniqueConstraint("AlternateKey_Uri", x => x.Uri);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookId = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Description = table.Column<string>(nullable: true),
                    FreeBase = table.Column<string>(nullable: true),
                    GndId = table.Column<string>(nullable: true),
                    GoogleImageCache = table.Column<string>(nullable: true),
                    ...
                    OpenLibId = table.Column<string>(nullable: true),
                    OrigLang = table.Column<string>(nullable: true),
                    OriginalImage = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TagCountId = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagsCount", x => x.TagCountId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WikiStorage", x => new { x.Id, x.Lang });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersActivities", x => x.UserActivityId);
                    table.ForeignKey(
                        name: "FK_UsersActivities_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookRatingId = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    BookId = table.Column<int>(nullable: false),
                    CreatedTime = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ratings", x => x.BookRatingId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BooksCharacters_BookId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagsCount_Lang",
                table: "TagsCount",
                column: "Lang",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UsersActivities_UserId",
                table: "UsersActivities",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_WikiStorage_Id",
                table: "WikiStorage",
                column: "Id");
        }
